...
func (au *AccountUpdate) check() error {
	if _, ok := au.mutation.RoleID(); au.mutation.RoleCleared() && !ok {
		return errors.New(`authdbgen: clearing a required unique edge "Account.role"`)
	}
	return nil
}
...
func (auo *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`authdbgen: missing "Account.id" for update`)}
	}
