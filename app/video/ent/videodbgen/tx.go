...
func (tx *Tx) init() {
	tx.OriginalVideo = NewOriginalVideoClient(tx.config)
	tx.SubtitledVideo = NewSubtitledVideoClient(tx.config)
}
...
// applies a query, for example: OriginalVideo.QueryXXX(), the query will be executed
